...
const PlaylistDetail = () => {
  ...
  return (
    <div className="flex-grow h-screen overflow-y-scroll scrollbar-hide">
      <section
        className={`flex flex-wrap xl:flex-nowrap items-end space-x-7 bg-gradient-to-b ${color} to-black text-white p-8 w-full py-20 sm:pb-28 text-center sm:text-start`}>
