...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 flex justify-between pt-5 pb-4 px-8 bg-neutral-800/30">
      <div className="flex items-center gap-2">
        <div
          onClick={() => router.back()}
          className="rounded-full p-1 bg-neutral-950/70 flex justify-center items-center"
        >
