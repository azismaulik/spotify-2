    ...
    <>
      {session && (
        <div
          ...
          } text-gray-500 border-r border-gray-900 sticky top-0 left-0 bottom-0 overflow-y-scroll h-screen scrollbar-hide text-xs lg:text-sm sm:w-[14rem] lg:w-[17rem] hidden md:block pb-12`}>
          ...
          <div>
            {playlists.map((playlist, i) => (
              <Link
                ...
                } cursor-pointer hover:text-white flex items-center gap-3 rounded hover:bg-neutral-900 p-2 mx-2`}>
                <Image
