...
export const Sidebar = () => {
  ...
  return (
    <div
      ...
      } text-gray-500 border-r border-gray-900 sticky top-0 left-0 bottom-0 overflow-y-scroll h-screen scrollbar-hide text-xs lg:text-sm sm:w-[17rem] lg:w-[20rem] hidden md:block`}
    >
      ...
      <div>
        {playlists.map((playlist, i) => (
          <Link
            ...
            } cursor-pointer hover:text-white flex items-center gap-3 rounded hover:bg-neutral-900 px-2 py-3 mx-2`}
          >
            <Image
